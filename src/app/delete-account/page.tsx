...
export default function DeleteAccountPage() {
  return (
    <main style={{ padding: 24, lineHeight: 1.6, color: 'var(--ink)' }}>
      <Link href="/" className="mono" style={{ fontSize: 'var(--text-caption)', letterSpacing: '.06em', color: 'var(--ink-2)' }}>← HOME</Link>
      <h1 style={{ fontSize: 'var(--text-title)', margin: '16px 0 4px' }}>Delete your Rydafirst account</h1>
      <p className="mono" style={{ fontSize: 'var(--text-caption)', color: 'var(--ink-2)', margin: 0 }}>LAST UPDATED 15 JULY 2026</p>

      <h2 style={{ fontSize: 'var(--text-subtitle)', marginTop: 24 }}>Delete it in the app</h2>
      ...
      <h2 style={{ fontSize: 'var(--text-subtitle)', marginTop: 20 }}>Or request it by email</h2>
      ...
      <h2 style={{ fontSize: 'var(--text-subtitle)', marginTop: 20 }}>What is deleted</h2>
      ...
      <h2 style={{ fontSize: 'var(--text-subtitle)', marginTop: 20 }}>What is kept, and for how long</h2>
      ...
      <h2 style={{ fontSize: 'var(--text-subtitle)', marginTop: 20 }}>Questions</h2>
