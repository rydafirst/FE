...
export default function TermsPage() {
  return (
    <main style={{ padding: 24, lineHeight: 1.6, color: 'var(--ink)' }}>
      ...
      <h2 style={{ fontSize: 'var(--text-subtitle)', marginTop: 24 }}>1. Who we are</h2>
      ...
      <h2 style={{ fontSize: 'var(--text-subtitle)', marginTop: 20 }}>2. Your account</h2>
      ...
      <h2 style={{ fontSize: 'var(--text-subtitle)', marginTop: 20 }}>3. Payments and escrow</h2>
      ...
      <h2 style={{ fontSize: 'var(--text-subtitle)', marginTop: 20 }}>4. Acceptable use and conduct</h2>
      ...
      <h2 style={{ fontSize: 'var(--text-subtitle)', marginTop: 20 }}>5. Prohibited items</h2>
      ...
      <h2 style={{ fontSize: 'var(--text-subtitle)', marginTop: 20 }}>6. Disputes</h2>
      ...
      <h2 style={{ fontSize: 'var(--text-subtitle)', marginTop: 20 }}>7. Liability</h2>
